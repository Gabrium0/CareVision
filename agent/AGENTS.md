...
- Files: `policy.py` (`Policy._candidates` picks conversation topics), `advisor_engine.py` (post-aggregation rules that emit `Result`s back into the aggregator), `moondream_client.py`, `voice_agent.py`, `env.py`.
