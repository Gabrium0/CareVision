...
| 13 | Facial asymmetry / droop | `facial_asymmetry` | mirror landmarks across face axis; flag change vs baseline (stroke FAST-F) | 🟡 screen, not dx |
| 14 | Facial / eyelid swelling | `facial_swelling` | slow eye-aperture / cheek-fullness drift vs long baseline | 🔴 longitudinal |
| **Motor / neurological** |
